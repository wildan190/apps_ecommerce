            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg p-6">
                ...
                <div class="bg-blue-100 dark:bg-blue-700 border border-blue-200 dark:border-blue-600 p-4 rounded-lg mb-4">
                    ...
                    <div class="mt-2">
                        ...
                        <a href="{{ route('admin.orders.show', $order->id) }}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded inline-block">
                            {{ __('Show') }}
                        </a>
                    </div>
                    <div class="mt-2">
                        <form action="{{ route('admin.orders.destroy', $order->id) }}" method="POST">
                            @csrf
                            @method('DELETE')
                            <button type="submit" class="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded inline-block" onclick="return confirm('Apakah Anda yakin ingin menghapus pesanan ini?');">
                                {{ __('Hapus') }}
                            </button>
                        </form>
                    </div>
